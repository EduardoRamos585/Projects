...
`timescale 1 ns / 1 ps
	...
	(
		...
		parameter integer C_AXI_ADDR_WIDTH	= 4 // Should be 4
    )
    (
       ...
       // output wire [26:0] Debug,
        ...
        input wire [C_AXI_ADDR_WIDTH-1 : 0] axi_awaddr,  //Enough bits so ip can use
    ...
    serial_slave_lite_v1_0_AXI # (
        .C_S_AXI_ADDR_WIDTH(C_AXI_ADDR_WIDTH)
    ) serial_slave_lite_v1_0_AXI_inst (
        .S_AXI_ACLK(axi_aclk),
